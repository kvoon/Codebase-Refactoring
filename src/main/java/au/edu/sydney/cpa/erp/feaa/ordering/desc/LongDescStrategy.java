...
public interface LongDescStrategy {
     ...
     */
    String generateLongDesc(Order order, OrderType orderType, PriorityType priorityType, ScheduleType scheduleType, boolean isFinalised);
